...
export default () => {
  ...
  const fetchCachedScores = async (playerId, service, serviceParams = {sort: 'recent', page: 1}, otherParams = {}) => {
    switch (service) {
      case 'beatsavior':
  ...
  const fetchLiveScores = async (player, service, serviceParams = {sort: 'recent', page: 1}, otherParams = {}) => {
    switch (service) {
      case 'beatsavior':
