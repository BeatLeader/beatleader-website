<!-- https://raw.githubusercontent.com/efeskucuk/svelte-color-picker/master/src/HsvPicker.svelte -->
<script>
	...
	function colorChangeCallback() {
		dispatch('colorChange', `rgba(${r}, ${g}, ${b}, ${a})`);
	}
	...
	<div class="main-container">
		...
		<div class="color-info-box">
			...
			<div class="hex-text-block">
				...
				<button class="hide-button" on:click={() => (expanded = false)}>Hide</button>
			</div>
