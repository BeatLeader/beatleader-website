...
<nav class={`ssr-page-container ${className ?? ''}`}>
	...
	<a
		...
		<div class="lottie-heart">
			{#if $configStore?.preferences?.openedLovege2026 || !$configStore?.preferences?.openedLovege2026}
			<LottiePlayer
				speed="1"
				width="1.3em"
				height="1.3em"
				autoplay
				loop={unreadValentines || !$configStore?.preferences?.openedLovege2026}
				controls={false}
	...
	<div class="right mobile-menu nav-button" on:click|preventDefault={() => (mobileMenuShown = !mobileMenuShown)}>
		...
		<div
			...
			<div class="dropdown-content">
				...
				<div class="dropdown-item">
					<a href="/about" aria-label="About" on:click|preventDefault={() => navigate('/about')}>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
				...
				<div class="dropdown-item">
					<a href="/developer" aria-label="Developer Portal" on:click|preventDefault={() => navigate('/developer')}>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				...
				<div class="dropdown-item">
					<a href="/privacy" aria-label="Privacy Policy" on:click|preventDefault={() => navigate('/privacy')}>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
				...
				<div class="dropdown-item">
					<a href="/help" aria-label="Help" on:click|preventDefault={() => navigate('/help')}>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
				...
				<div class="dropdown-item">
					<a href="/socket" aria-label="Scores Feed" on:click|preventDefault={() => navigate('/socket')}>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				...
				<div class="dropdown-item">
					<a
						href="/supporting-project/link"
						aria-label="Claim Rewards"
						on:click|preventDefault={() => navigate('/supporting-project/link')}>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
