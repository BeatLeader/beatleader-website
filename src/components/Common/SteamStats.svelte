<script>
  ...
  {#if lastTwoWeeksTime}
    <div class="steam-stats" title="{lastTwoWeeksTime} hours played last 2 weeks. And {allTime} hours played all time."><span style="color: #8992e8">{lastTwoWeeksTime}</span>|<span style="color: #8992e8">{allTime}</span>h </div>
  {/if}
