...
<div class="selectContainer badge-bg">
	<Select value={selected} {itemFilter} {items} {Item} Selection={Item} isSearchable={true} on:select></Select>
</div>
...
<style>
    ...
    .selectContainer :global(.selectContainer) {
