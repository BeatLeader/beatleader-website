<script>
	...
	$: isLoloppe = $account.player && ($account.player.playerId == '76561198073989976' || $account.player.playerInfo.role.includes('admin'));
...
<MetaTags
	title={ssrConfig.name + ' - Tag selector'}
