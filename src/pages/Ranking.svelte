			...
			{#if showDetails}
				<div class="event-details">
					<span>
						...
						scores and climb this leaderboard. Top 1
						<span style="color: yellow;" title={formatDate(dateFromUnix(1682251199))}>
							{formatDateRelative(dateFromUnix(1682251199))}
						</span>
						will get the "Earth's bff" badge!
